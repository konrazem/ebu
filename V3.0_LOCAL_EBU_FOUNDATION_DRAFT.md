...
- **Gate 1 — quote layer.** Implement and validate the pure local signed
  quote: committed quote schedule, natural-regeneration exclusion,
  telescoping, split-action controls, P1C orthogonality, information
  boundary, and the V2.6 red-team replay — the full plan of §17.
...
remark, Corollary 8.3, and the §16 register line for Theorem 6.9). No code,
