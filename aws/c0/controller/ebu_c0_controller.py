...
def validate_launch(record: Any, rehearsal: str, attempt: str) -> dict[str, Any]:
    ...
    expected = {
        "schema": "aws_c0_launch_request/v9", "authority_id": AUTHORITY_ID,
    ...
    kinds = {
        ...
        "preparation_packet_identity": "aws_c0_preparation_packet/v9",
        "preparation_authorization_identity": "aws_c0_preparation_authorization/v8",
...
def build_platform_smoke_known_case_local_binding(record: Any) -> dict[str, Any]:
    ...
    inputs = (
        ("LAUNCH_REQUEST", identity("aws_c0_launch_request/v9", launch["record_sha256"])),
...
def _ssm_request_identity(launch_id: str, live_packet_id: str,
    ...
    preimage = {
        ...
        "live_packet_identity": identity("aws_c0_live_packet/v9", live_packet_id),
        "live_authorization_identity": identity("aws_c0_live_authorization/v9", live_auth_id),
...
def validate_helper_local_source_context(args: argparse.Namespace, launch_raw: bytes, source_raw: bytes) -> dict[str, Any]:
    ...
    if (start['attempt_identity'] != launch['attempt_identity'] or launch['artifact_prefix'] != args.artifact_prefix
            ...
            or source['live_authorization_identity'] != identity('aws_c0_live_authorization/v9',args.live_authorization_sha256)
...
def prepare_request(args: argparse.Namespace, *, credential_provider: Any = bootstrap_imdsv2_credentials,
    ...
    if not isinstance(live_packet, dict) or live_packet.get("schema") != "aws_c0_live_packet/v9" or "record_sha256" in live_packet:
    ...
    if live_packet.get("launch_request_identity") != identity("aws_c0_launch_request/v9", launch_id) or live_packet.get("launch_request_object") != launch_receipt or live_packet.get("packet_disposition") != "AWS_C0_LIVE_PACKET_COMPLETE_UNAUTHORIZED":
    ...
    if not isinstance(live_auth, dict) or live_auth.get("schema") != "aws_c0_live_authorization/v9" or "record_sha256" in live_auth or live_auth.get("live_packet_identity") != identity("aws_c0_live_packet/v9", args.live_packet_sha256) or live_auth.get("live_packet_object") != packet_receipt or live_auth.get("attempt_identity") != launch["attempt_identity"]:
    ...
    source = {
        ...
        "live_authorization_identity": identity("aws_c0_live_authorization/v9", args.live_authorization_sha256),
        "workflow_execution_identity": workflow_id,
...
def new_local_operational_status(launch: dict[str, Any], workflow_execution_arn: str) -> dict[str, Any]:
    ...
    if launch.get('schema') != 'aws_c0_launch_request/v9':
    ...
    return {'schema':'aws_c0_controller_operational_status/v2','attempt_id':launch['attempt_id'],
        ...
        'launch_request_identity':identity('aws_c0_launch_request/v9',launch_id),'artifact_prefix':launch['artifact_prefix'],
...
def run_attempt(args: argparse.Namespace) -> None:
    ...
    if live_packet.get("schema") != "aws_c0_live_packet/v9" or live_auth.get("schema") != "aws_c0_live_authorization/v9":
    ...
    claim = {
        ...
        "attempt_identity": launch["attempt_identity"],
        "launch_request_identity": identity("aws_c0_launch_request/v9", launch_id),
        "live_packet_identity": identity("aws_c0_live_packet/v9", source["live_packet_sha256"]),
