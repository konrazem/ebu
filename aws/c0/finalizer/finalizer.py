...
FROZEN_PRELIVE_RECORD_KINDS = (
    ...
    "aws_c0_preparation_packet/v8",
    "aws_c0_preparation_authorization/v7",
    ...
    "aws_c0_launch_request/v8",
    "aws_c0_preparation_closure/v7",
)
...
ROOT_KINDS = (
    ...
    "aws_c0_material_runtime_static_validation/v4",
    "aws_c0_private_infrastructure_snapshot/v1",
    "aws_c0_launch_request/v8", "aws_c0_start_receipt/v7", "aws_c0_heartbeat/v1",
...
CURRENT_PHASE_KINDS = {'aws_c0_closure_seed/v2','aws_c0_preparation_packet/v8','aws_c0_preparation_authorization/v7',
                       'aws_c0_launch_request/v8','aws_c0_preparation_closure/v7','aws_c0_live_packet/v8','aws_c0_live_authorization/v8'}
...
LIVE_PACKET_V8_FIELDS = LIVE_PACKET_V6_FIELDS | {
...
LIVE_AUTH_V8_FIELDS = LIVE_AUTH_V6_FIELDS | {"runtime_control_reconstruction_source_attachment_identity"}
...
LAUNCH_V8_FIELDS = LAUNCH_V6_FIELDS
CATEGORY = {
...
def _validate_launch_v8(record: Any) -> dict[str, Any]:
    return _validate_launch(record,'aws_c0_launch_request/v8',LAUNCH_V8_FIELDS,
                            'aws_c0_preparation_packet/v8','aws_c0_preparation_authorization/v7')
...
def validate_deployment_sequence(packet: dict[str, Any], auth: dict[str, Any], seed: dict[str, Any],
    ...
    for parent, child, id_field, receipt_field, kind, root in (
        (auth, packet, 'live_packet_identity', 'live_packet_object', 'aws_c0_live_packet/v8', False),
        (packet, launch, 'launch_request_identity', 'launch_request_object', 'aws_c0_launch_request/v8', True),
...
def _validate_live_packet_v8(packet: dict[str, Any]) -> None:
    """Validate the truthful prospective predeployment carrier.

    V8 preserves the nine v7 preimages and every action, permission, session,
    ...
    """
    if set(packet) != LIVE_PACKET_V8_FIELDS or packet.get("schema") != "aws_c0_live_packet/v8":
        raise Refusal("live-packet-v8 field closure failed")
    _common(packet, "aws_c0_live_packet/v8", root=False)
    ...
    _identity(packet, "preparation_closure_identity", "aws_c0_preparation_closure/v7")
    _identity(packet, "launch_request_identity", "aws_c0_launch_request/v8")
...
def _validate_live_authorization_v8(auth: dict[str, Any]) -> None:
    if set(auth)!=LIVE_AUTH_V8_FIELDS or auth.get('schema')!='aws_c0_live_authorization/v8':
        raise Refusal('live-authorization-v8 field closure failed')
    _common(auth,'aws_c0_live_authorization/v8',root=False)
    _identity(auth,'live_packet_identity','aws_c0_live_packet/v8')
...
def preflight(event: dict[str, Any]) -> dict[str, Any]:
    ...
    auth, _, auth_id = _fetch_receipt(event["live_authorization"], "aws_c0_live_authorization/v8", root=False)
    _validate_live_authorization_v8(auth)
    ...
    packet, _, packet_id = _fetch_receipt(auth["live_packet_object"], "aws_c0_live_packet/v8", root=False)
    _validate_live_packet_v8(packet)
    if auth.get("live_packet_identity") != identity("aws_c0_live_packet/v8", packet_id):
    ...
    launch, launch_receipt, launch_id = _fetch_receipt(packet["launch_request_object"], "aws_c0_launch_request/v8", root=True)
    _validate_launch_v8(launch)
    if packet.get("launch_request_identity") != identity("aws_c0_launch_request/v8", launch_id):
    ...
    return {
        ...
        "launch_request_identity": identity("aws_c0_launch_request/v8", launch_id),
        "launch_request_object": launch_receipt,
        "live_packet_identity": identity("aws_c0_live_packet/v8", packet_id),
        "live_packet_object": auth["live_packet_object"],
        "live_authorization_identity": identity("aws_c0_live_authorization/v8", auth_id),
...
def _resource_use(launch: dict[str, Any], seed_id: str, seed_receipt: dict[str, Any],
    ...
    rows = [{"dimension": name, "unit": UNITS[name], "observation_disposition": "SEALED_MAXIMUM_SUBSTITUTION",
             ...
             "maximum_substitution_source_identity": identity("aws_c0_launch_request/v8", launch_id)}
    ...
    return _control_record("aws_c0_resource_use_closure/v3", {
        ...
        "closure_seed_object": seed_receipt, "launch_request_identity": identity("aws_c0_launch_request/v8", launch_id),
...
def _semantic_roots(launch: dict[str, Any], launch_receipt: dict[str, Any], launch_id: str,
    ...
    roots.append((identity("aws_c0_launch_request/v8", launch_id), launch_receipt))
...
def _verify_prelive_objects(packet_receipt: dict[str, Any], auth_receipt: dict[str, Any],
    ...
    packet, _, packet_id = _fetch_receipt(packet_receipt, "aws_c0_live_packet/v8", root=False)
    auth, _, auth_id = _fetch_receipt(auth_receipt, "aws_c0_live_authorization/v8", root=False)
    _validate_live_packet_v8(packet); _validate_live_authorization_v8(auth)
    if auth["live_packet_identity"] != identity("aws_c0_live_packet/v8", packet_id):
    ...
    verified.extend([
        {"record_or_object_identity": identity("aws_c0_live_packet/v8", packet_id), "object": packet_receipt,
         "verification_disposition": "EXACT_VERSION_COMPLETE_BYTES_PASS"},
        {"record_or_object_identity": identity("aws_c0_live_authorization/v8", auth_id), "object": auth_receipt,
         "verification_disposition": "EXACT_VERSION_COMPLETE_BYTES_PASS"},
    ])
    return verified
...
def closure(event: dict[str, Any]) -> dict[str, Any]:
    ...
    seed, seed_receipt, seed_id = _exact_environment_record("CLOSURE_SEED", "aws_c0_closure_seed/v2", root=False)
    model, model_receipt, model_id = _exact_environment_record("COST_MODEL", "aws_c0_cost_model/v2", root=False)
    launch, launch_receipt, launch_id = _exact_environment_record("LAUNCH", "aws_c0_launch_request/v8", root=True)
    _validate_launch_v8(launch)
    _validate_cost_model(model, model_id, launch)
