...
**Version:** 0.1.15
**Status:** Prospective I-3 fault-class vector authority correction only; accepted I-3A, I-3B, I-3C, and the regression-compatibility repair remain frozen; I-3D is unimplemented; no scientific execution, Gate, publication, or release authority
**Date:** 2026-08-12
...
#### 2.1.2 Current v0.1.15 prospective authority register
...
implementing it or changing I-2. Revision v0.1.10 corrected the complete
implementation-path/substage ownership bijection. Revision v0.1.11 corrected
only the local semantic predicates and materialized witnesses recorded in
§20.12. Revision v0.1.12 corrected only the historical `FailureCode` whole-enum
assumption and froze the one-time maintenance boundary recorded in §20.13
and §22. Revision v0.1.13 corrected only that boundary's omission of the
adjacent historical prefix-length assertion, freezes exactly three future
assertion expressions, and adds the anti-rebinding constraints recorded in
§20.14 and §22. Revision v0.1.14 replaces the active books-structure pointer,
registers the integrated Part I revision plan as prospective manuscript-
planning authority, records accepted I-3B and the accepted one-time repair,
and changes no scientific or implementation authority. Revision v0.1.15
records accepted I-3C and corrects only the four constructor-unreachable
fault-class vectors and their dependent authority locks; I-3D remains
unimplemented. The v0.1.2
...
| `UNIFIED_PYTHON_RESEARCH_FRAMEWORK_I3_AUTHORITY_AMENDMENT.md` | v1.0.5 normative human I-3 rendering | `eaa3c80efa6ff0beae6f3ad8da3be67fb61f3cc5223b2067c256732ebf7bdfbc` | Four-vector `FaultClass` reachability correction, exact resealing, preserved validator truth sets/outcomes, historical maintenance authority, and unchanged I-3 path ownership |
| `unified_python_research_framework_i3_contract.json` | v1.0.5 mechanical I-3 contract | `d8acef250314e1405b048a324c9f855010f7927cc8760e2f827bba85253d7979` | Exact two-member `FaultClass` domain, four-vector correction scope, current validation identities, preserved 53/35/88 inventories, and unchanged 23-path bijection |
| `unified_python_research_framework_i3_validation_contract.json` | v1.0.2 validation contract | `9ecd849f24ecd3e55883874263c10c181fea2e16a3000e87e4fc7fe02c2ccb2b` | Exact corrected 544-vector materialization, four-vector change inventory, complete two-route semantic evidence, collision rule, bytes, and digest |

The books-structure and Part I plan hashes in this table are their only active
authority values for this specification revision, and the conservation-
...
This prospective Part I planning-authority reconciliation changes no imported
Bridge or Dynamic Coordination semantic, framework object, interface,
invariant, event phase, accepted I-1/I-2/I-3 test classification,
implementation byte, or current implementation permission.
...
#### 2.1.7 Integrated Part I revision-planning boundary

`PART_I_EXPLANATORY_VISUAL_AND_INSTITUTIONAL_REVISION_PLAN.md` is prospective
manuscript-planning authority only. It defines the evidence, preservation,
explanation, figure, institutional-separation, and layout gates that a later
independently authorized Part I revision proposal must satisfy. It does not
authorize mutation of the Part I source or PDF, PDF regeneration, rebuilding
or regenerating Parts I–III, any change to Parts II or III, framework
implementation, any repeat of the accepted historical assertion repair, I-3D,
model-state advance, a Gate operation, publication, or release.

The planning lock preserves without reinterpretation:

- all accepted I-1 and I-2 implementation and packaging identities, the
  complete I-3 authority amendment, mechanical contract, validation contract
  and 544-vector corpus identities, the accepted I-3A, I-3B, and I-3C implementations,
  and the accepted one-time regression-compatibility repair;
- the Sequential–Parallel Bridge, Dynamic Coordination, and conservation and
  boundary-accounting authorities and every equation, theorem, result, Gate
  state, interpretation limit, and nonclaim they protect;
- retirement of the broad O2 actor/coalition historical-profit-cap objective
  without a replacement family, together with the fixed-field cycle identity,
  same-actor quote independence, and the distinction between an equivalent
  repair and a genuinely larger verified improvement;
- the rule that EBU penalizes verified physical burden rather than distance
  itself, with no automatic distance coefficient, universal distance tax, or
  inverse-square EBU force;
- the entropy boundary: thermodynamic entropy, Shannon information, and any
  EBU-specific candidate must remain separately typed, unit- and boundary-
  declared concepts, and EBU is not asserted to be a thermodynamic law;
- the separation of physical conservation, represented-stock closure, EBU
  accounting, causal attribution, institutional settlement, and compensation;
- the open status of long-run viability, invariance, stability, attraction,
  recovery, and compositional homeostasis until Part V earns the applicable
  theorem under explicit assumptions;
- the exact nine-figure selective visual programme and its evidence, symbol,
  unit, provenance, accessibility, contrast, caption, and placement gates;
- the measured typography and pagination trials, representative-page renders,
  complete-PDF visual acceptance gate, and the rule that no layout winner is
  selected in advance; and
- non-destructive Part I revision mechanics: verified source/PDF baselines,
  a complete change ledger and content inventories, textual and visual
  redlines, recoverable baseline artifacts, and no unexplained deletion or
  rewrite, while Parts II and III remain untouched and byte-identical.

These are future manuscript acceptance requirements, not a manuscript edit or
scientific finding. A separate authority must expressly permit Part I source
mutation and PDF generation before either can begin.
...
by merge commit `ede89d8af6b89da491e03c352efcf1868a913f6f`. I-3A was subsequently
accepted at feature commit `83dc39866799c57af99e8a2001ff2bfa8e60d282`
and integrated at merge commit
`c7daa0bbc2ee10bbd1d2fad8f2a68c9ee51d591a`. The exact one-time regression-
compatibility repair was subsequently accepted at feature commit
`8a10bbb8301f9891b1e90d7f40c9878780b37b48` and integrated at merge commit
`453f14525bbe9ec1fed74d0d37feb4f2e52e4217`. I-3B was accepted at feature
commit `0312f29d69b3dcf639a49be9a25d43e76036715d` and integrated at merge
commit `d14928a1f6f9837d9ab895cc2ea64c8562bb4f27`. I-3C was accepted at feature
commit `5ec122d45ebe617ebc1d761bc5d1f5172b736c41` and integrated at merge
commit `95f3c1990d32859dd091756a68571959406f2c1b`. Revision v0.1.15 reopens
none of those accepted stages. It corrects only four prospective I-3D
validation vectors and grants no I-3D implementation, I-5, framework-alpha,
manuscript/PDF mutation, scientific execution, Gate, publication, or release
authority.
...
### 20.11 Revision v0.1.10 — historical prospective I-3 path-ownership correction
...
state, interpretation, or execution permission. Its now-historical whole-file
raw SHA-256 is `ae37f7e20145420f98858c85d2191ba2b42c8432a134537af3dad92177fb07b8`.

### 20.12 Revision v0.1.11 — historical prospective I-3 semantic-witness correction

Revision v0.1.11 adopts amendment v1.0.2, mechanical contract v1.0.2, and
validation contract v1.0.1. It freezes identity-agnostic order and duplicate
witnesses; exact conservation level, evidence, and isolation tables and scans;
the complete paired-quantity inventory; and disjoint local ownership for
applicability, measurement-unit, fault-order, state-contamination, and
execution-hash facts. It also freezes the exact coordinate-only state
projection after removal of exactly five reserved contamination keys, freezes
exact `ObjectRef` triples for settlement links, repairs the four affected state
inputs and four stale settlement child-receipt hashes, and removes the rejected
draft's contradictory permission for non-reserved state-payload extras. It corrects the 18 defective adjacent order-before-
duplicate vectors, preserves already-valid `i3v-23-a03`, corrects
`i3v-11-p`, `i3v-16-p`, `i3v-04-s10`, and `i3v-04-s11`, and reseals every
dependent materialized input, projection, envelope, failure ID, and digest.

The correction changes 227 vectors and preserves 317, including all 207
formation vectors. Two independent standard-library-only reconstructions
audit all 544 vectors with zero failures and no conflicting effective-input
outcome. It changes no closed public inventory, implementation path, accepted
I-1/I-2 byte or semantic, scientific model or equation, Gate rule, or
...
### 20.13 Revision v0.1.12 — historical prospective I-3 regression-compatibility correction

Revision v0.1.12 adopts amendment v1.0.3 and mechanical contract v1.0.3 while
preserving validation contract v1.0.1 byte-identically. It freezes the
accepted I-1/I-2 `FailureCode` inventory as an exact immutable ordered
53-code prefix, preserves the accepted exact 35-code I-3A suffix, and freezes
the current complete inventory as their exact 88-code concatenation.

It identifies exactly two stale whole-enum assertion scopes in
`tests/framework/test_primitives_envelopes.py` and defines a future one-time
implementation that may change only those assertion sites to validate the
first 53 members or values against the complete historical prefix. That
implementation requires separate explicit authorization and is not performed
or authorized by this revision. Exact prefix and suffix validation remains
mandatory, and duplicate, mutation, reorder, insertion, deletion, or
unauthorized suffix change remains detectable.

The maintenance path is assigned to no I-3 substage and changes neither the
23-path I-3A–I-3E ownership bijection nor its 5/6/5/4/3 counts. The historical
30-path I-1/I-2 manifest remains immutable evidence; during this documentation
correction every selected path remains byte-identical, and under the later
one-time authorization every accepted production and test path other than the
single named test remains frozen. This revision changes no implementation or
test byte, runtime behavior, failure value or precedence, vector, validator,
declaration, scientific definition, Gate rule, dependency, export, or
execution permission. Its now-historical whole-file raw SHA-256 is
`beb8608bfa0bc12809b3ac49e8310dc23611715e8b13e913b48a0ae0c54f61f0`.

### 20.14 Revision v0.1.13 — historical prospective exact three-assertion repair-scope correction

Revision v0.1.13 adopts amendment v1.0.4 and mechanical contract v1.0.4 while
preserving validation contract v1.0.1 byte-identically. It preserves the
exact immutable ordered 53-code historical prefix, accepted ordered 35-code
I-3A suffix, immutable current 88-code sequence, append-only future boundary,
and all three inventory identities from v0.1.12.

Its then-active books-structure raw SHA-256 was
`0c8eeb402b201e81e20c0167f5b66d93ccb9d6d847d1c4c145891e145c9ec26f`;
that value is historical and is not an active v0.1.15 authority lock.

It corrects the one-time maintenance inventory from two assertion sites to
exactly three assertion-expression changes in two existing methods and one
existing test file. The added expression is the adjacent historical
prefix-length assertion. Both first-method assertions explicitly slice
`failure_members[:53]`; `failure_members` remains the complete current enum
tuple throughout that method. The second method prefix-scopes only
`FailureCode`, leaving every other enum comparison whole-domain exact.

No assignment expression, walrus operator, rebinding, mutation, truncation,
aliasing, helper insertion, individual I-3 failure-code copy, hidden input
change, or change outside the exact three expressions is permitted. The
maintenance path remains outside I-3A–I-3E and leaves the 5/6/5/4/3 ownership
counts unchanged. This revision changes no implementation or test byte,
fixture, validator, vector, failure code, public API, scientific definition,
Gate rule, dependency, export, runtime behavior, or execution permission.
Its now-historical whole-file raw SHA-256 is
`f7eb5dfe3d63b422e1a449e64db5b1b8464760afdb4054e485ed4e647b59a8bb`.

### 20.15 Revision v0.1.14 — historical prospective Part I planning-authority reconciliation

Revision v0.1.14 adopts the integrated Part I planning sources at the active
raw hashes in §2.1.2. It registers the new plan as prospective manuscript-
planning authority, records the accepted regression-compatibility repair and
accepted I-3B integration, and leaves I-3C and every later implementation or
scientific stage separate and unbegun.

It preserves all accepted I-1/I-2/I-3 implementation and packaging bytes; the
Bridge, Dynamic Coordination, conservation, I-3 amendment, mechanical
contract, validation contract, and corpus identities; every scientific
definition, equation, theorem status, result, Gate state, and nonclaim; and the
Part I plan's O2 retirement, fixed-field cycle, same-actor, distance/burden,
entropy, conservation, homeostasis, institutional-separation, nine-figure,
typography/render, and Parts II–III preservation boundaries. It authorizes no
manuscript or PDF mutation, framework implementation, scientific execution,
model-state advance, Gate operation, publication, or release. This document
had whole-file raw SHA-256 `0f6ab9800acda8890ae2a28d4652552af9cf5b335d4b00619eb8f0dbe892041e`.
That identity is historical and is not an active v0.1.15 lock.

### 20.16 Revision v0.1.15 — current prospective fault-class vector authority correction

Revision v0.1.15 adopts amendment v1.0.5, mechanical contract v1.0.5, and
validation contract v1.0.2 at the exact active hashes in §2.1.2. It records
accepted I-3C at merge commit
`95f3c1990d32859dd091756a68571959406f2c1b` and preserves the accepted I-1,
I-2, I-3A, I-3B, I-3C, and one-time regression-repair bytes.

The revision changes exactly four logical validation vectors:
`i3v-20-s05`, `i3v-20-a04`, `i3v-20-a05`, and `i3v-20-m`. Within their fully
materialized inputs it replaces only the out-of-domain
`OPERATIONAL_DURABILITY_EVENT` value with the already-authorized
`OPERATIONAL_DURABILITY_INJECTION` value and reseals all dependent canonical
payloads, projections, hashes, references, evidence, envelopes, failure IDs,
and corpus/component identities. The exact two-member `FaultClass` domain,
all 544 IDs, categories, active predicate sets, precedence outcomes, expected
outcomes, scientific nonclaims, and every other logical vector remain
unchanged.

This revision authorizes no implementation or test edit, fixture creation,
fault delivery, configuration or experiment construction, scientific
execution, model-state advance, Gate operation, publication, or release.
I-3D remains unimplemented. This document does not contain its own current
whole-file hash.
...
not active current-authority pointers. Revision v0.1.15 changes none of
...
Revision v0.1.15 changes no accepted I-2 implementation byte and authorizes no
implementation stage. The exact assertion-only exception defined in §22 was
subsequently implemented and accepted at the feature and integration commits
recorded in §19; it is now frozen historical implementation evidence and
creates no permission for another repair.
...
1. `UNIFIED_PYTHON_RESEARCH_FRAMEWORK_I3_AUTHORITY_AMENDMENT.md` v1.0.5 at raw SHA-256 `eaa3c80efa6ff0beae6f3ad8da3be67fb61f3cc5223b2067c256732ebf7bdfbc`;
2. `unified_python_research_framework_i3_contract.json` v1.0.5 at raw SHA-256 `d8acef250314e1405b048a324c9f855010f7927cc8760e2f827bba85253d7979` and canonical SHA-256 `384f289fbd20524d193eed9d852334915bf41b8b18b5096f1b7fb8ca9788a534`; and
3. `unified_python_research_framework_i3_validation_contract.json` v1.0.2 at raw SHA-256 `9ecd849f24ecd3e55883874263c10c181fea2e16a3000e87e4fc7fe02c2ccb2b` and canonical SHA-256 `ba70b9915ebc5957225adc3f4806d89a540bec86560a29d63471613af2659079`.

The amendment is the normative human rendering; the first JSON is the mechanical schema and ordering source; the second JSON is the fully materialized validation source. Any mismatch fails closed. Version 1.0.5 narrowly supersedes v1.0.4 only for the four fault-class vector inputs named in §20.16, their dependent seals, and the resulting authority coordinates. All other v1.0.4 authority remains in force; older hashes remain explicitly historical only. The exact `FaultClass` domain remains `SCIENTIFIC_MODEL_EVENT` and `OPERATIONAL_DURABILITY_INJECTION`. This correction changes no closed public inventory, failure value, precedence position, intended predicate truth, expected outcome, validator, declaration, import graph, export inventory, I-3 implementation-path ownership, scientific definition, equation, model, result, protocol, Gate state, interpretation, or execution permission.

I-3A is accepted and integrated at `c7daa0bbc2ee10bbd1d2fad8f2a68c9ee51d591a`; I-3B at `d14928a1f6f9837d9ab895cc2ea64c8562bb4f27`; and I-3C at `95f3c1990d32859dd091756a68571959406f2c1b`. Their bytes and authority remain frozen. The exact one-time test repair is accepted and integrated at `453f14525bbe9ec1fed74d0d37feb4f2e52e4217`. This revision authorizes no implementation edit, fixture installation, test execution, I-3D start, registry acceptance, scientific use, state advance, or I-4–I-8 behavior.
...
#### 22.2.1 Historical failure-prefix compatibility and separate maintenance path

The accepted I-1/I-2 `FailureCode` inventory is the exact ordered 53-code
prefix below. The first line is ordinals 1–29 and the second is ordinals
30–53; together they are one sequence:
...
The historical sequence is an immutable ordered 53-code prefix. Accepted I-3A
owns and has installed the exact ordered 35-code suffix in §22.3 immediately
after that prefix at ordinals 54–88. Their complete ordered 88-code
concatenation, `CURRENT_88_CODES`, is itself the immutable current
`FailureCode` prefix and remains exact and duplicate-free. Every future code
must be appended strictly after ordinal 88; the first possible future code is
therefore ordinal 89 under one-based numbering and index 88 under zero-based
indexing. No future authority may insert, remove, replace, rename, reorder, or
duplicate a code within ordinals 1–53, between ordinals 53 and 54, within
ordinals 54–88, or anywhere before the current ordinal-88 endpoint.
Equivalently, every future valid inventory `F` must satisfy
`F[:88] == CURRENT_88_CODES`.

Each ordered inventory digest uses exactly
`b"".join(name.encode("ascii") + b"\n" for name in inventory)`, where
`b"\n"` is one real LF byte `0x0a`, including after the final name. ASCII and
UTF-8 bytes are identical for every failure-code name. Declared order is
preserved, and the serialization has no BOM, prefix, suffix, spaces, CR,
blank lines, or other separator. The historical 53-code inventory is exactly
1,136 bytes with SHA-256
`94b7d2b611f0d15b68ba296dec2156cf0bbdbd7dac97a534a157286386fdb7be`;
the accepted I-3 35-code suffix is exactly 989 bytes with SHA-256
...
The accepted one-time repair changed exactly three assertion expressions in
`tests/framework/test_primitives_envelopes.py`, confined to exactly two
existing methods.
...
`failure_members` remains the complete current enum tuple throughout this
method. Both independent historical assertions explicitly observe
`failure_members[:53]`: ordered equality checks the exact historical prefix,
and the adjacent assertion checks the length of that same prefix.
...
Only `FailureCode` is prefix-scoped; every other enum comparison remains
whole-domain exact. No assignment expression, walrus operator, rebinding,
mutation, truncation, aliasing, helper insertion or extraction, individual
I-3 failure-code copy, hidden input change, or change outside these exact
three expressions was permitted. Every other statement, assertion, import,
constant, helper, method, class, formatting-only region, production path, and
test path remained byte-identical. The repair was accepted at feature commit
`8a10bbb8301f9891b1e90d7f40c9878780b37b48` and integrated at merge commit
`453f14525bbe9ec1fed74d0d37feb4f2e52e4217`; this revision performs no further
change and grants no repeat authorization.

The historical test remains responsible only for the exact ordered 53-code
prefix. The accepted I-3A test remains responsible for the exact 35-code
suffix and complete current 88-code inventory. The current 88-code sequence
remains immutable; future additions begin only at ordinal 89/index 88 and
must preserve `F[:88] == CURRENT_88_CODES`, so duplicate, prefix mutation,
reorder, insertion, deletion, and unauthorized suffix change remain
detectable.

This maintenance path is assigned to no I-3 substage and is outside the
unchanged 23-path I-3A–I-3E bijection and 5/6/5/4/3 counts. The historical
30-path I-1/I-2 manifest remains immutable evidence. The accepted one-time
authorization changed only the named test path; all other accepted I-1/I-2
production and test paths remain frozen.
...
The state-projection algorithm has one exact meaning. Begin with the supplied state payload. For `SystemState.physical_state_payload` only, remove exactly `policy_memory`, `policy_memory_payload`, `causal_contribution`, `settlement_share`, and `settlement_allocation` for the projection predicate check. The remaining payload must be exactly the coordinate-only object `{"coordinates":[[ObjectRef-ECJ1,ECJ1-value],...]}` with no other top-level key. A remaining non-reserved extra key activates `STATE_PROJECTION_FAILURE`; the mere presence of a removed reserved key activates only its contamination owner, `PHYSICAL_POLICY_MEMORY_CONFLATION`. Represented and other state payloads receive no removal. Empty coordinates are structurally valid but activate `MISSING_COORDINATE` when required coordinates are absent. Duplicate, noncanonical, malformed, and otherwise invalid coordinate content keeps its frozen ownership and precedence.

Every directly supplied settlement quote/receipt/group/child/share/residual/closure `ObjectRef` link must equal the paired record's envelope `ObjectRef` in all three fields—object ID, version, and content hash. No opaque-reference meaning is inferred; any unequal triple activates `SETTLEMENT_LINK_INVALID` at its frozen precedence position.
...
Every ordered or duplicate-free tuple and every applicability/sum union has an exact formation/validator owner in the mechanical contract. Route segment order is semantic rather than canonical. Order invalidity requires unequal members at `i < j` with `key[i] > key[j]`; duplication requires equal complete projections. Isolated witnesses are `[B,A]` and `[A,A]`; the combined order-before-duplicate witness is `[B,A,A]`. The 19 adjacent combined vectors contain 18 corrections plus preserved already-valid `i3v-23-a03`.

The mechanical contract freezes 24 exact conservation rows with separate profile-invalid, level-missing, evidence-incomplete, and isolation-invalid scans. Reduced stock is not closed or isolated; open control volume requires modeled nonzero external exchange and forbids a zero-exchange claim; isolated completeness forbids nonzero exchange, loss, and unresolved content and requires exact-zero channels plus boundary, carrier, zero, and complete observability evidence. Internal-transfer eligibility is local to an explicit common profile boundary and proves no containment or cancellation. The 12-row paired-quantity inventory enumerates every direct unit/dimension comparison and its scan position. No opaque identity supplies unit, dimension, clock, interval, completeness, or scientific meaning.
...
Two independent standard-library-only external implementations reconstructed and semantically audited byte-identical canonical vector bytes: **24179582 bytes**, exactly one final LF, SHA-256 `e5790524bb7d63dcc18e15cd933d801c225253230f09b06d9828a703fc6218c5`. They agreed with zero failures on ordered IDs, names, effective inputs, outcomes, predicate truth sets, constructor reachability, failure IDs, successful projections, exact object-content scans, collection and applicability rules, paired-quantity relations, conservation scans, state projections, settlement links, artifact rules, bytes, newline, digest, and collision audit. The ordered `[vector_id, precedence_evidence.active_failure_codes]` predicate-truth projection has unchanged SHA-256 `8812d40f5eb8f79722cf6aefe2df0eff7adae0494415ec146b3e9ab950be9f89`. The audit found 543 unique effective inputs, one benign identical input (the sole one-member enum positive/boundary formation), and zero conflicting outcomes.
...
Historical validation v1.0.1 changed 227 vectors and preserved 317 relative to v1.0.0; that evidence remains immutable history. Current validation v1.0.2 changes exactly `i3v-20-s05`, `i3v-20-a04`, `i3v-20-a05`, and `i3v-20-m` relative to v1.0.1 and preserves 540 logical vectors. No vector is added or removed. Every category, active predicate set, precedence outcome, expected outcome, and all 207 formation vectors remain unchanged. The four vectors now use the authorized `OPERATIONAL_DURABILITY_INJECTION` enum value throughout their materialized inputs, with all dependent seals rederived. The future repository fixture is absent and I-3D is unimplemented.
