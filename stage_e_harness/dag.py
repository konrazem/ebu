...
def complexity_cell(vertices: int, edges: int, cell_class: str) -> dict[str, int | str]:
    ...
    edge_rows = _complexity_edges(vertices, edges)
    ...
    return {
        ...
        "class": cell_class,
        "elapsed_ns": elapsed,
        "primary_operations": result.counters.indegree_initializations + result.counters.edge_inspections,
        "logical_storage_slots": result.counters.logical_storage_slots,
        ...
        "ready_node_comparisons": result.counters.ready_node_comparisons,
    }
