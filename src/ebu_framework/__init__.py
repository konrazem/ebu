...
# Framework I-5 surface.  This suffix is kept separate so the accepted
# 309-name root projection above remains byte-for-byte ordered.
from .hashing import (
    EventKeyDigest,
...
from .faults import FaultHookBoundary, validate_inert_fault_hook


_I5_EXECUTION_EXPORTS = frozenset(
    {
        "ProposalRecord",
...
def __getattr__(name: str):
    if name in _I5_EXECUTION_EXPORTS:
...
from .correction_diagnostics import (
