...
thm("<b>Theorem 7.1.</b> Assume continuous time (Model C); "
    ...
    "C&sup1;, so <font face='Courier'>V_state &isin; C&sup1;</font> and the RHS is Lipschitz "
    "(unique C&sup1; solutions). With drive "
...
thm("<b>Corollary 7.2 (undriven, LaSalle, stated precisely).</b> If "
    "<font face='Courier'>u_i &equiv; 0</font> and trajectories are bounded (they are, "
    "<font face='Courier'>x &isin; [0,K]</font>), then V_state is non-increasing and by "
    "LaSalle the flow converges to the <b>largest invariant subset</b> of the "
    "zero-dissipation set "
    "<font face='Courier'>Z = { J_e = 0 &forall;e } = { f_e &le; &theta;_e &forall;e }</font>. "
    "This claims <b>only</b> convergence to Z. It does <b>not</b> assert V_state = 0, "
    "complete homeostasis, a unique equilibrium, or which point of Z is reached &mdash; Z "
    "is generally a continuum, and any stronger claim needs a separate argument.")
